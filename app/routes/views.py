...
daily_order = [
        "DAILY REACH", "DAILY IMPRESSIONS", "DAILY VIEWS",
        "DAILY FOLLOWERS GAIN", "DAILY NEW LIKES", "DAILY ENGAGEMENTS"
    ]
monthly_order = [
        "MONTHLY REACH", "MONTHLY IMPRESSIONS", "MONTHLY VIEWS", "MONTHLY ENGAGEMENTS"
    ]
total_order = [
        "TOTAL REACH", "TOTAL IMPRESSIONS", "TOTAL VIEWS",
        "TOTAL FOLLOWERS", "TOTAL LIKES", "TOTAL ENGAGEMENTS"
    ]
